...
{ 
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
      ...
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "tree_vert_line.gif>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></a></td>"
  ...
  {
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "tree_node_blank.gif height=2 width=2>"
  }
  if (WRAPTEXT)
  ...
  { 
    ...
    docW = docW + this.desc
  docW = docW + "</td>"
  docW = docW + "<td valign=middle nowrap width=100%>"+this.postpendHTML+"</td>"
...
function nodeImageSrc() {
  ...
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "tree_lastnode.gif"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "tree_minus_lastnode.gif"  
      else
        srcStr = ICONPATH + "tree_plus_lastnode.gif"  
  } 
  else 
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "tree_node.gif"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "tree_minus_node.gif"
      else
        srcStr = ICONPATH + "tree_plus_node.gif"
  }   
  return srcStr;
}
...
{ 
  ...
  if (this.level>0) 
    ...
    { 
      leftSide = leftSide + "<td valign=top><img src='" + ICONPATH + "tree_lastnode.gif' width=16 height=22></td>"
    } 
    else 
    { 
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "tree_vert_line.gif><img src='" + ICONPATH + "tree_node.gif' width=16 height=22></td>"
    } 
  ...
  if (USEICONS)
	  ...
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "tree_node_blank.gif height=2 width=3>"
...
function blockStartHTML(idprefix) {
  ...
  docW = docW + "<table cellspacing=0 cellpadding=0 width=100%>"
...
function leftSideHTML(leftSideCoded) {
	...
	for (i=0; i<leftSideCoded.length; i++)
	{
		...
		{
			retStr = retStr + "<td valign=top background=" + ICONPATH + "tree_vert_line.gif><img src='" + ICONPATH + "tree_vert_line.gif' width=16 height=22></td>"
		}
		if (leftSideCoded.charAt(i) == "0")
		{
			retStr = retStr + "<td valign=top><img src='" + ICONPATH + "tree_node_blank.gif' width=16 height=22></td>"
		}
	}
	return retStr
}
...
function preLoadIcons() {
	var auxImg
	auxImg = new Image();
	auxImg.src = ICONPATH + "tree_vert_line.gif";
	auxImg.src = ICONPATH + "tree_minus_lastnode.gif";
	auxImg.src = ICONPATH + "tree_minus_node.gif";
	auxImg.src = ICONPATH + "tree_plus_lastnode.gif";
	auxImg.src = ICONPATH + "tree_plus_node.gif";
	auxImg.src = ICONPATH + "tree_node_blank.gif";
	auxImg.src = ICONPATH + "tree_lastnode.gif";
	auxImg.src = ICONPATH + "tree_node.gif";
...
var PRESERVESTATE = 0;
var ICONPATH = '/Windchill/extcore/com/digitek/pdm/images/';
var HIGHLIGHT = 0;
