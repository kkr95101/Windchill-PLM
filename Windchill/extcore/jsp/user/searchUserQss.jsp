...
<script>
	...
	function onLoad() {
		...
		userGrid.setHeader("이름,이메일,조직,가입일");
		userGrid.setColumnIds("displayName,email,org,regDate");
		userGrid.setInitWidthsP("20,30,20,30");
	...
	function getUsers() {
		$.ajax({
			url : "/Windchill/servlet/dgt/user/getUsers/qss",
			type : "get",
			dataType : "json",
			data : {},
